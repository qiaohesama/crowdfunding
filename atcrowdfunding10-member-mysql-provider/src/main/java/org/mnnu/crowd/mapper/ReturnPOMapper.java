...
import org.mnnu.crowd.entity.po.ReturnPOExample;
...
public interface ReturnPOMapper {
    ...
    void insertReturnPOBatch(@Param("returnPOList") ArrayList<ReturnPO> returnPOList,@Param("projectPOId") Integer projectPOId);
}