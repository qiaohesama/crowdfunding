            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                    ...
                    <a class="btn btn-primary" style="float:right;"
                       onclick="window.location.href='admin/to/addAdmin/page'"><i class="glyphicon glyphicon-plus"></i>
                        新增
                    </a>
                    <br>
                    <hr style="clear:both;">
                    <div class="table-responsive">
                        <table class="table  table-bordered">
                            ...
                            <c:if test="${empty requestScope.pageInfo.list}">
                                <tr>
                                    <td colspan="6" align="center">抱歉没有查到您要的数据</td>
                                </tr>
                            </c:if>
                            <c:if test="${not empty requestScope.pageInfo.list}">
                                <c:forEach items="${requestScope.pageInfo.list}" var="admin">
                                    <tr>
                                        ...
                                        <td>${admin.email}</td>
                                        <td>
                                            <a href="assign/to/page?adminId=${admin.id}&pageNum=${requestScope.pageInfo.pageNum}&keyword=${param.keyword}"
                                               class="btn btn-success btn-xs"><i
                                                    class=" glyphicon glyphicon-check"></i></a>
                                            <a href="admin/to/update/${admin.id}?pageNum=${requestScope.pageInfo.pageNum}"
                                               class="btn btn-primary btn-xs"><i
                                                    class=" glyphicon glyphicon-pencil"></i></a>
                                            <a href="admin/delete/${admin.id}/${requestScope.pageInfo.pageNum}/${param.keyword}"
...
<script type="text/javascript">
    ...
    function initPagination() {
        ...
        const properties = {
            ...
            prev_text: "上一页",
            next_text: "下一页",
            items_per_page:${requestScope.pageInfo.pageSize},   // 每页显示 几 项
